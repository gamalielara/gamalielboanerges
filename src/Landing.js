            ...
            <div className="hello-container w-full h-full flex justify-start items-center bg-black relative">
                <div className="hello-content md:pl-16 md:p-0 p-4 z-10">
                    ...
                    <div className="buttons flex gap-4 md:mt-8 sm:mt-4 mt-2">
                        <motion.button className="transition-all bg-transparent md:text-2xl text-lg border-white border-2 hover:border-0 hover:border-transparent hover:bg-gum-dark-red text-white p-2 mr-2" initial={{scale:0}} animate={{scale:1}} transition={{delay:1.25}}><Link to="/projects">MY WORKS</Link></motion.button>
                        <motion.button className="transition-all bg-transparent md:text-2xl text-lg border-white border-2 hover:border-0 hover:border-transparent hover:bg-gum-dark-red text-white p-2 ml-2" initial={{scale:0}} animate={{scale:1}} transition={{delay:1.5}}><Link to="/about-me">ABOUT ME</Link></motion.button>
                    </div>
