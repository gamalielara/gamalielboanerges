    ...
    return (
        <motion.div className="myskills-projects-wrapper" initial={{opacity:0}} animate={{opacity:1}}>
            <div className="w-full h-screen relative">
                <motion.h1 className="my-works-skills lg:text-8xl md:text-6xl text-5xl absolute text-gum-dark-red top-1/2 left-1/2 z-10" initial={{fontSize: "0rem"}} animate={{fontSize: "4rem"}} transition={{delay: .75}}>My Skills & Works</motion.h1>
            ...
            <section className="skills w-full min-h-screen my-8">
                <h1 className="text-5xl lg:text-7xl text-gum-dark-red mb-4 md:mb-8">My Skills</h1>
                <div className="myskills flex flex-wrap sm:px-4 md:w-5/6 mx-auto w-full justify-center items-center">
                    ...
                    <motion.div className="lg:w-1/6 sm:w-1/3 w-1/4 mx-4 cursor-pointer" whileHover={{ scale:1.2 }}>
                        ...
                        <h3 className="text-white md:text-lg text-base">CSS Framework: Tailwind</h3>
                    </motion.div>
                    <motion.div className="lg:w-1/6 sm:w-1/3 w-1/4 mx-4 cursor-pointer" whileHover={{ scale:1.2 }}>
                        <img src="img/skills/bootstrap.png" alt="Bootstrap" className="object-contain w-full"/>
                        <h3 className="text-white md:text-lg text-base">CSS Framework: Bootstrap</h3>
                    </motion.div>
                    <motion.div className="lg:w-1/6 sm:w-1/3 w-1/4 mx-4 cursor-pointer" whileHover={{ scale:1.2 }}>
                    ...
                    <motion.div className="lg:w-1/6 sm:w-1/3 w-1/4 mx-4 cursor-pointer" whileHover={{ scale:1.2 }}>
                        ...
                        <h3 className="text-white md:text-lg text-base">Adobe Illustrator</h3>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="my-projects text-white w-full p-4 bg-black my-4">
                <div className="my-projects-container">
                    <h1 className="text-5xl lg:text-7xl text-gum-dark-red ">My Projects</h1>
                    ...
                    <div className="projects flex flex-wrap w-full justify-center align-middle mt-4">
                        ...
                        <motion.div className="project-card hover:bg-gum-dark-red bg-gum-red lg:w-1/4 w-5/6 m-4 transition-all rounded-lg cursor-pointer" whileHover={{scale:1.2}}>
                            ...
                            <div className="project-desc p-2">
                                ...
                                <div className="links flex justify-center mt-2">
                                    <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="https://github.com/gamalielara/folklorevermore-chess" target="_blank" className="underline italic text-sm">Code<i class="fas fa-code ml-2"></i></a></div>
                                    <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="https://gamalielara.github.io/folklorevermore-chess/" target="_blank" className="underline italic text-sm">Website<i class="fas fa-external-link-alt ml-2"></i></a></div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div className="project-card hover:bg-gum-dark-red bg-gum-red lg:w-1/4 w-5/6 m-4 transition-all rounded-lg cursor-pointer" whileHover={{scale:1.2}}>
                            ...
                            <div className="project-desc p-2">
                                ...
                                <div className="links flex justify-center mt-2">
                                    <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="https://github.com/gamalielara/react-to-do-list" target="_blank" className="underline italic text-sm">Code<i class="fas fa-code ml-2"></i></a></div>
                                    <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="https://gamalielara.github.io/react-to-do-list/" target="_blank" className="underline italic text-sm">Website<i class="fas fa-external-link-alt ml-2"></i></a></div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div className="project-card hover:bg-gum-dark-red bg-gum-red lg:w-1/4 w-5/6 m-4 transition-all rounded-lg cursor-pointer" whileHover={{scale:1.2}}>
                            ...
                            <div className="project-desc p-2">
                                ...
                                <div className="links flex justify-center mt-2">
                                    <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="https://github.com/gamalielara/libSHELF-app" target="_blank" className="underline italic text-sm">Code<i class="fas fa-code ml-2"></i></a></div>
                                    <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="http://libshelf.infinityfreeapp.com/" target="_blank" className="underline italic text-sm">Website<i class="fas fa-external-link-alt ml-2"></i></a></div>
                                </div>
                            </div>
                        ...
                        <motion.div className="project-card hover:bg-gum-dark-red bg-gum-red lg:w-1/4 w-5/6 m-4 transition-all rounded-lg cursor-pointer" whileHover={{scale:1.2}}>
                            ...
                            <div className="links flex justify-center mt-2">
                                <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="https://github.com/gamalielara/gumrindelwald" target="_blank" className="underline italic text-sm">Code<i class="fas fa-code ml-2"></i></a></div>
                                <div className="link  m-2 p-1 hover:bg-gum-red cursor-pointer rounded transition-all"><a href="https://gumrindelwald.netlify.app/" target="_blank" className="underline italic text-sm">Website<i class="fas fa-external-link-alt ml-2"></i></a></div>
                            </div>
                            </div>
                        </motion.div>
