        ...
        <section className="my-blog w-full h-screen relative">
            <div className="content absolute top-1/2 left-1/2 w-full center z-10 flex flex-col gap-4 justify-center items-center">
                ...
                <motion.article class="px-4 text-white md:w-3/4 sm:w-5/6 w-full lg:text-lg md:text-base text-sm" initial={{opacity:0}} animate={{opacity:1}} transition={{delay:1.5, duration:1}}>
                    ...
                    <p class="md:mb-4 mb-2">All article in this website (or, at least, in majority) are written in both Indonesian and English. And because I currently spend my time learning new languages (German and Russian), you might find some of them are written in German as well (I am still struggling with Russian and its complex grammar, but I will write in Russian in the future).</p>
                </motion.article>
            ...
            <motion.div className="gradient min-h-screen w-full relative after:absolute after:top-0 after:left-0 after:bg-gum-dark-red after:opacity-30" initial={{opacity:0}} animate={{opacity:1}}>
                <img src="img/gumrindelwald-hero.jpg" alt="background" className="object-cover w-full h-full absolute top-0 left-0"/>
            </motion.div>
        </section>
     );
}
